...
HEATMAP_XLSX = BASE_DIR / "heatmap_analysis_clean.xlsx"
AOI_WIDE_CSV = BASE_DIR / "aoi_analysis_EOCR" / "aoi_metrics_wide.csv"
DEEPGAZE_CSV = BASE_DIR / "deepgaze_evaluation" / "deepgaze_metrics_by_image.csv"
EFFICIENTNET_PRED_CSV = BASE_DIR / "efficientnet_b0_optuna" / "best_trial_predictions.csv"

OUTPUT_DIR = BASE_DIR / "final_integrated_interpretation"
