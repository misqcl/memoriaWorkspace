...
QA_FILE = os.path.join(BASE_DIR, "analisis_2", "valid_response_matrix.xlsx")

QA_SHEET = "Usable"

OUTPUT_DIR = os.path.join(BASE_DIR, "analisis_2", "image_heatmaps")
...
# ==========================================================
# LOAD VALID GAZE + EMOTIONAL-RESPONSE MATRIX
# ==========================================================
...
if usable.empty:
    raise ValueError(
        f"Sheet '{QA_SHEET}' in {QA_FILE} is empty."
    )

print(
    f"Matrix loaded: "
    f"{usable.shape[0]} images × "
    f"{usable.shape[1] - 1} users"
)
