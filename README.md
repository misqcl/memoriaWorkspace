...
Este repositorio no contiene imágenes, las imágenes obtenidas a partir de los códigos se pueden encontrar en el siguiente [Drive](https://drive.google.com/drive/folders/119HusQkFD-aInhsXiRmzBspSU3ZxTEeI).
## Definiciones
